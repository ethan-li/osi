    ...
    def test_installer_help_option(self):
        ...
        try:
            ...
            if result.returncode == 0:
                ...
                if "usage" in output_lower or "help" in output_lower or "options" in output_lower:
    ...
    def test_distribution_methods_available(self):
        ...
        try:
            ...
            for func_name in required_functions:
                self.assertTrue(hasattr(build_distributions, func_name),
    ...
    def test_distribution_summary_creation(self, mock_run):
        ...
        try:
            ...
            self.assertTrue(summary_file.exists(),
                          "DISTRIBUTION_GUIDE.md should be created")
    ...
    def test_all_build_scripts_exist(self):
        ...
        for script in required_scripts:
            ...
            self.assertTrue(script_path.is_file(),
                          f"Build script {script} should be a file")
