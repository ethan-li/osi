...
class TestWheelOnlySystem(unittest.TestCase):
    ...
    def test_wheel_only_functionality(self):
        ...
        for tool_name in tools:
            ...
            self.assertIsNotNone(
                wheel_info, 
                f"Tool {tool_name} should have corresponding wheel"
            )
    ...
    def test_no_tools_directory(self):
        ...
        self.assertFalse(
            tools_dir.exists(),
            "Tools directory should not exist in wheel-only system"
        )
...
class TestSystemValidation(unittest.TestCase):
    ...
    def test_all_imports_work(self):
        ...
        try:
            from osi import config_manager
            from osi import wheel_manager
            from osi import launcher
            from osi import environment_manager
            from osi import dependency_resolver
            from osi import pyproject_parser
            from osi import tool_config
    ...
    def test_system_consistency(self):
        ...
        wheel_tools = set(wheel.tool_name for wheel in wheel_manager.list_available_tools())
