...
from osi.wheel_manager import WheelManager, WheelInfo
...
class TestWheelManager(unittest.TestCase):
    ...
    def test_find_wheel_by_name(self):
        ...
        if wheels:
            ...
            found_wheel = self.wheel_manager.find_wheel_by_name(existing_wheel.tool_name)
            
            self.assertIsNotNone(found_wheel, f"Should find wheel for {existing_wheel.tool_name}")
