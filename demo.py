...
def main():
    ...
    run_command(
        "python scripts/osi.py info data_analyzer",
        "Show Tool Information"
    )
    ...
    run_command(
        "python scripts/osi.py list",
        "Updated Tool List (After Installation)"
    )
    
    # Demonstrate tool usage
    run_command(
        "python scripts/osi.py run file_organizer -- --help",
        "Show File Organizer Help"
    )
    ...
    run_command(
        "python scripts/osi.py run data_analyzer -- --help",
        "Show Data Analyzer Help"
    )
